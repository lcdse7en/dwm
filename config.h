...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("pamixer --allow-boost -d 15; kill -44 $(pidof dhttps://github.com/LukeSmithxyz/dwmblocks.gitwmblocks)") },
  ...
  { MODKEY|ShiftMask, XK_g, spawn, SHCMD("rofi -show drun") },
...
#endif
	{ ClkStatusText,        ShiftMask,      Button1,        sigdwmblocks,   {.i = 6} },
	{ ClkStatusText,        ShiftMask,      Button3,        spawn,          SHCMD(TERMINAL " -e nvim ~/dwmblocks/config.h") },
