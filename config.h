...
static char *fonts[] = {"JetbrainsMono Nerd Font Mono:size=10",
...
/* commands */
static const char *termcmd[] = {TERMINALKitty, NULL};
...
static Key keys[] = {
    ...
    {MODKEY,
     XK_e,
     spawn,
     {.v = (const char *[]){TERMINAL, "-e", "pcmanfm", NULL}}},
    // { MODKEY,			XK_v,		spawn,		{.v =
    // (const char*[]){ TERMINAL,
    // "-e", "nvim",
    // "-c", NULL, NULL } } },
     ...
     */
    // { MODKEY,			XK_r,		spawn,          {.v =
    // (const char*[]){ "dmenu_run", NULL } } },

    {MODKEY, XK_F9, spawn,
     SHCMD(
         "feh --bg-fill --randomize ~/Pictures/wallpapers/use/1920*1080/* &")},
    {MODKEY, XK_F10, spawn, SHCMD("~/.local/bin/slock")},
    // { MODKEY,			                  XK_F10,
    // spawn,
    // {.v = slockcmd } },
    {MODKEY, XK_r, spawn,
     SHCMD("rofi -theme use -font 'JetbrainsMono 20' -show drun -show-icons")},
    {MODKEY, XK_g, spawn, {.v = (const char *[]){TERMINAL, "-e", "lf", NULL}}},
    {MODKEY | ShiftMask,
     XK_k,
     spawn,
     {.v = (const char *[]){TERMINAL, "-e", "kdenlive", NULL}}},
    {MODKEY, XK_w, spawn, {.v = (const char *[]){BROWSER, NULL}}},
    {MODKEY | ShiftMask,
     XK_w,
     spawn,
     {.v = (const char *[]){BROWSER, "https://github.com/lcdse7en", NULL}}},
    {MODKEY,
     XK_v,
     spawn,
     {.v = (const char *[]){BROWSER, "https://www.bilibili.com/", NULL}}},
    {MODKEY | ShiftMask,
     XK_v,
     spawn,
     {.v =
    ...
    {MODKEY | ShiftMask,
     XK_h,
     spawn,
     {.v = (const char *[]){BROWSER,
                            "https://www.ijujitv.cc/show/1-----------2023.html",
                            NULL}}},
    {MODKEY | ShiftMask,
     XK_l,
     spawn,
     {.v = (const char *[]){BROWSER, "192.168.1.4:8000", NULL}}},
     ...
     * },
     */
    /* { MODKEY|ShiftMask,		XK_Return,	togglesmartgaps,
     * {0}
     * },
     */
    ...
    /*	{ MODKEY,			XK_F9,		spawn,		{.v =
       (const char*[]){ "dmenumount", NULL } } },*/
    /*	{ MODKEY,			XK_F10,		spawn,		{.v =
       (const char*[]){ "dmenuumount", NULL } } },*/
    {MODKEY, XK_F11, spawn,
    ...
    /*	{ MODKEY,			XK_Print,	spawn,		{.v =
       (const char*[]){ "dmenurecord", NULL } } },*/
    /*	{ MODKEY|ShiftMask,		XK_Print,	spawn,		{.v =
       (const char*[]){ "dmenurecord", "kill", NULL } } },*/
    /*	{ MODKEY,			XK_Delete,	spawn,		{.v =
       (const char*[]){ "dmenurecord", "kill", NULL } } },*/
    /*	{ MODKEY,			XK_Scroll_Lock,	spawn,
       SHCMD("killall screenkey
       || screenkey &") },*/
    ...
    /*	{ 0, XF86XK_AudioPrev,		spawn,		{.v = (const char*[]){
       "mpc", "prev", NULL } } }, { 0, XF86XK_AudioNext,		spawn,
       {.v = (const char*[]){ "mpc",  "next", NULL } } }, { 0,
       XF86XK_AudioPause,		spawn,
       {.v = (const char*[]){ "mpc", "pause", NULL } } }, { 0, XF86XK_AudioPlay,
       spawn,		{.v = (const char*[]){ "mpc", "play", NULL } } }, { 0,
       XF86XK_AudioStop,		spawn,		{.v = (const char*[]){
       "mpc", "stop", NULL
       }
       }
       }, { 0, XF86XK_AudioRewind,	spawn,		{.v = (const char*[]){
       "mpc", "seek", "-10", NULL } } }, { 0, XF86XK_AudioForward,	spawn,
       {.v = (const char*[]){ "mpc", "seek", "+10", NULL } } }, { 0,
       XF86XK_AudioMedia,		spawn,		{.v = (const char*[]){
       TERMINAL,
       "-e", "ncmpcpp", NULL } } }, { 0, XF86XK_AudioMicMute,	spawn,
       SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle") }, { 0,
       XF86XK_PowerOff, spawn,		{.v = (const char*[]){ "sysact", NULL }
       } }, { 0, XF86XK_Calculator,		spawn,		{.v = (const
       char*[]){ TERMINAL, "-e", "bc",
       "-l", NULL } } }, { 0, XF86XK_Sleep,		spawn,		{.v =
       (const char*[]){ "sudo", "-A", "zzz", NULL } } }, { 0, XF86XK_WWW,
       spawn,		{.v = (const char*[]){ BROWSER, NULL } } }, { 0,
       XF86XK_DOS,		spawn,		{.v = termcmd } }, { 0,
       XF86XK_ScreenSaver,	spawn,		SHCMD("slock & xset dpms force
       off; mpc pause; pauseallmpv") }, { 0, XF86XK_TaskPane,		spawn,
       {.v = (const char*[]){ TERMINAL, "-e", "htop", NULL } } }, { 0,
       XF86XK_Mail,		spawn, SHCMD(TERMINAL " -e neomutt ; pkill
       -RTMIN+12 dwmblocks") }, { 0,
       XF86XK_MyComputer,		spawn,		{.v = (const char*[]){
       TERMINAL,
       "-e", "lfub",  "/", NULL } } }, { 0, XF86XK_Battery,		spawn,
       SHCMD("") },
            { 0, XF86XK_Launch1,		spawn,		{.v = (const
       char*[]){ "xset", "dpms", "force", "off", NULL } } }, { 0,
       XF86XK_TouchpadToggle, spawn,		SHCMD("(synclient | grep
       'TouchpadOff.*1' && synclient TouchpadOff=0) || synclient TouchpadOff=1")
       }, { 0, XF86XK_TouchpadOff, spawn,		{.v = (const char*[]){
       "synclient", "TouchpadOff=1", NULL } }
       }, { 0, XF86XK_TouchpadOn,		spawn,		{.v = (const
       char*[]){ "synclient", "TouchpadOff=0", NULL } } }, { 0,
       XF86XK_MonBrightnessUp,	spawn,		{.v = (const char*[]){
       "xbacklight",
       "-inc", "15", NULL } } }, { 0, XF86XK_MonBrightnessDown,	spawn,
 ...
 */
    ...
    {ClkStatusText, ShiftMask, Button3, spawn,
     SHCMD(TERMINAL " -e nvim ~/github_upload/dwmblocks/config.h")},
